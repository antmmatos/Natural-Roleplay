...
RegisterCommand("scforcereload", function()
    Setup()
end)
...
function UpdatePlayerTable(connectedPlayers)
    ...
    local ems, police, redline, bennys, cardealer, players = 0, 0, 0, 0, 0, 0, 0
...
RegisterKeyMapping('sc', 'Scoreboard', 'keyboard', 'F10')

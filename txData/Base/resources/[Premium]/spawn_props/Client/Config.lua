translate = {
    ...
    TR_TITLE_CREATE         = "PROPS",
    TR_SUBTITLE_CREATE      = "Create prop",
    ...
    TR_CREATE_BUTTON_GROUND = "Put on the floor",
    TR_CREATE_FOLDER        = "Folder",
    ...
    TR_ELEMENT_DUPLICATE    = "Duplicate",
    TR_ELEMENT_CANCEL       = "Cancel" ,
    TR_TITLE_FOLDERS        = "PROPS",
    TR_SUBTITLE_FOLDERS     = "Folders",
    TR_FOLDER_ACTIVE_ALL    = "Active All",
    TR_FOLDER_DISABLE_ALL   = "Disable All",
    TR_FOLDER_DELETE_ALL    = "Delete Folder",
    TR_CLICK_HERE           = "Click here" ,
    TR_PRESS_KEY            = "Press F5" ,
    TR_TO_USE               = "To use the mouse" ,
    TR_TO_CAM               = "To move",

    TR_SEARCH1              = "Search Prop",
    TR_SEARCH2              = "Search Folder",
}

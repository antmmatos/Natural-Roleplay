...
Config.CassetteMin = 10000 -- The minimum amount of money from the box
Config.CassetteMax = 25000 -- The maximal amount of money from the box

Config.Lastrobbed = 0 -- do not touch
Config.SecBetwNextRob = 3600 -- Seconds between the possibility of another seizure

Config.TimeToEnd = 20 * 60000 --(20minutes) Time after which the bounty will end if the heist in the shop does not start

Config.shoprobbery = {
	['BossSpawn'] = { 
		Pos = {x = 189.18, y = -14.79, z = 73.22, h = 249.22}, -- Place where you start the job
...
Config.Shops = {
    ['District Murrieta Heights'] = {
        ...
        Money = math.random(175000, 225000), -- The money you get from the safe
    },

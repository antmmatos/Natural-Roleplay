...
(function(){
	let MenuTpl =
		...
		'<div class="head"><div class="headtitle">NATURAL ROLEPLAY</div></div>' +
		'<div class ="pos"><hr></div>'+
				'<div class="menu-items">' + 
					...
					'<div class="footer-items"' +
							...
							'<button class="boton3"><i class="fa fa-hand-pointer"></i> SELEC.</i></button>'+
							'<button class="boton2"><i class="fa fa-arrow-left"></i> SAIR</button>'+						
							'</p>'+
	...
	window.ESX_MENU       = {};
	ESX_MENU.ResourceName = 'NaturalSideMenu';
	ESX_MENU.opened       = {};
	ESX_MENU.focus        = [];
	ESX_MENU.pos          = {};

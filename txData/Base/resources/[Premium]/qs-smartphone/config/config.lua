...
Config.UseQBCorechecks = false -- Use QBCore events to optimise phone checks
...
Config.okokTextUI = {
    enable = true, -- If you use false, by default there will be DrawText3D
...
Config.Jobs = {
    ...
    { job = 'mechanic', name = 'Mecânico', img = './img/apps/mechanic.png'},
}
...
Config.EnableBooth = false -- Do you want to enable the phone booths?
...
Config.CustomDispatchSide = 'server' 
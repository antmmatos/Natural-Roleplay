...
Config.BlacklistedVehicles = { -- all vehicles that are not allowed to be sold (check the gameName on vehicles.meta -> <gameName>Supra</gameName>)
}
...
Config.BotName = 'Logs okokContract' -- Write the desired bot name
